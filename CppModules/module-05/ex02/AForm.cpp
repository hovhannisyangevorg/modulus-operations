...
AForm::AForm(const AForm& other):_signed_(other._signed_),_gradeExec_(other._gradeExec_), _gradeSign_(other._gradeSign_),_name_(other._name_) {}
...
bool AForm::getSigned() const { return this->_signed_; }

int AForm::getGradeExec() const { return this->_gradeExec_; }

int AForm::getGradeSign() const { return this->_gradeSign_; }

std::string AForm::getName() const { return this->_name_; }
